...
data = dict(
    imgs_per_gpu=16, workers_per_gpu=0, train=train_dataset, val=val_dataset)
...
export = dict(export_type = 'onnx', preprocess_jit = False, batch_size=1, blade_config=dict(enable_fp16=True, fp16_fallback_op_ratio=0.01), use_trt_efficientnms=False)
